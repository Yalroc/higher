class MessagesController < ApplicationController
  ...
  def create
    @job_application = JobApplication.find(params[:job_application_id]) # récupérer les id job_applicationet de job_offer, new_message
    ...
    @user = current_candidate || current_recruiter # celui qui écrit est soir un candidate soit un recruiter
